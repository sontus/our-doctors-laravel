            ...
            <div class="col-xl-3 col-sm-6 m-t35">
                <div class="card card-coin">
                    <div class="card-body text-center">
                        ...
                        <p class="mb-0 fs-14">
                            <span class="text-success mr-1">{{$category}}</span>
                        </p>	
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 m-t35">
                <div class="card card-coin">
                    <div class="card-body text-center">
                        ...
                        <h2 class="text-black mb-2 font-w600">Hospitals</h2>
                        <p class="mb-0 fs-13">
                            <span class="text-success mr-1">{{ $hospital}}</span>
                        </p>	
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 m-t35">
                <div class="card card-coin">
                    <div class="card-body text-center">
                        ...
                        <h2 class="text-black mb-2 font-w600">Doctors</h2>
                        <p class="mb-0 fs-14">
                            <span class="text-success mr-1">{{ $doctor}}</span>
                        </p>	
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 m-t35">
                <div class="card card-coin">
                    <div class="card-body text-center">
                        ...
                        <h2 class="text-black mb-2 font-w600">Chambers</h2>
                        <p class="mb-0 fs-14">
                            
                            <span class="text-success mr-1">{{ $chamber }}</span>
                        </p>	
                    </div>
                </div>
            </div>
